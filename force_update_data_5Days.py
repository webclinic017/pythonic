...
data.forceUpdateDataAll(numdays=5, watchlistName="WatchListDB.pickle", persist=True, chunksize=150)
# data.forceUpdateDataAll(numdays=2, watchlistName="WatchListLive.pickle", persist=True, chunksize=150)
