...
def main():
    ...
    #downloading
    stdate= "2018-01-01"    #  input('start date in format yyyy-mm-dd:')
    eddate= "2020-12-01"    # input('end date in format yyyy-mm-dd:')
    ticker= "AAL"          # input('ticker:')
